...
const Feature = (props: Props) => {
    ...
    return (
        <section id="feature">
            <div className="flex flex-col gap-4 mt-8 px-10 md:px-32 items-center">
                <HText>A perfect fit for everyone</HText>
