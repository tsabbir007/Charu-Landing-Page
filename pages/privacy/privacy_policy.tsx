...
const privacy_policy = (props: Props) => {
            ...
            <div className="container mt-32 mx-auto md:px-36">
                ...
                <div className="mt-10 px-8 sm:px-0">
                    ...
                    <p className="mb-10 italic">
                        The highlighted text is aimed to give a plain English summary of our Privacy Policy. Please ensure you read the main text, as the plain English summary is just a summary and doesn’t capture all of the terms.
                    </p>
                    <span className="font-bold text-3xl my-10 font-sand"> What does this policy cover</span>
                    <p className="my-10">
                        Welcome to Canva, the online and mobile service of Canva Pty Ltd (“Canva,” “we,” or “us”). Our Privacy Policy explains how we collect, use, disclose, and protect information that applies to our visual communication platform (the "Service"), and your choices about the collection and use of your information. Capitalized terms that are not defined in this Privacy Policy have the meaning given to them in our Terms of Use. If you do not want your information processed in accordance with this Privacy Policy in general or any part of it, you should not use our Service. This policy applies to all users of the Service, including, but not limited to users of our Developer Portal.
                    </p>
                    <div className="bg-c2deff p-4 rounded">
                        <p className="italic">
                            Summary: Welcome, here is our policy on privacy. This policy sets out how Canva collects and uses the information that we collect about you when you use the Service. This policy also explains the choices that you can make about the way that we use your information.
                        </p>
                    </div>
