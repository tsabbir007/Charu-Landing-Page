...
const AnchorLink = ({ page, selectedPage, setSelectedPage, isMenuToggled, setIsMenuToggled }: Props) => {
  ...
  return (
    <Link
      className={`${selectedPage === lowerCasePage ? "text-primary-100" : "text-black-500"} font-normal text-sm md:text-base transition duration-300 ease-in-out hover:text-primary-100`}
      href={`#${lowerCasePage}`}
      onClick={(event) => {
